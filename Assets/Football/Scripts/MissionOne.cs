...
public class MissionOne : MonoBehaviour
{
    ...
    //GAME INDICATORS
#warning Objects to build in after game works properly
    ...
    void Start()
    {
        ...
        goal = new GoalModel("Goal");//("sgk_goal");
#warning Maybe build in TextViews!
        /*
...
#warning Objects to build in after game works properly
    ...
    void Init()
    {
        ...
        //player = new PlayerModel(Instantiate(glove, glove.transform.position, Quaternion.Euler(new Vector3(0, 0, 0))) as GameObject);
        player = new PlayerModel(glove as GameObject);
        ...
        //this.grass = Instantiate(grass, grass.transform.position, Quaternion.Euler(new Vector3(0, 0, 0))) as GameObject;
        //}
...
#warning Coins
    ...
    IEnumerator Spawn()
    {
        ...
        while (!gameOver)
        {
            ...
            GameObject obj;
            if (objectGamePool.Length == 1)
            {
                obj = this.activateObject(0);
            }
            else
            {
                obj = this.activateObject(Random.Range(0, this.objectGamePool.Length));
            }
    ...
    IEnumerator spawnCoins()
    {
        ...
        for (int i = 0; i < spawnNCoins; i++)
        {
            ...
            if (obj != null)
            {
                ...
                Vector3 spawnPosition = new Vector3(Random.Range(-maxWidth, maxWidth), this.transform.position.y, 0.0f);
                Quaternion spawnRotation = Quaternion.identity;
                obj.transform.position = spawnPosition;
                obj.transform.rotation = spawnRotation;
                obj.SetActive(true);*/
